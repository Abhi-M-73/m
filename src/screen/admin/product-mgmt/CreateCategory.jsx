...
import { createCategory, getAllCategoriesForAdmin, deleteCategory, toggleCategory } from "../../../api/category.api";
                            ...
                            >
                                ...
                                <div className="flex gap-4 items-start">
                                    ...
                                    {category.image ? (
                                        ...
                                        <div className="h-20 w-20 rounded-lg bg-gray-200 flex items-center justify-center text-gray-500 text-xs">
                                            No Image
                                        </div>
                                    )}
                                    ...
                                    <div className="flex-1 space-y-1">
                                        ...
                                        <p className="text-sm text-gray-500 px-3 py-1 rounded-full bg-gray-100 w-fit">
                                            {category.slug}
                                        </p>
                                        ...
                                        <p className="text-sm text-gray-600 line-clamp-2">
                                            {dateFormatter(category.createdAt) || "No description"}
                                        </p>
                                    </div>
                                </div>
