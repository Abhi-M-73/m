...
const DashboardHeader = ({ headerName = "Dashboard" }) => {
  ...
  return (
    <div className="bg-white backdrop-blur-sm sticky top-0 z-30 border-b border-gray-300 shadow-sm w-full">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between ">
          ...
          <div className="flex items-center justify-end gap-2 sm:gap-4 relative flex-wrap">
            <button
              ...
              className="p-1.5 sm:p-2 rounded-lg text-gray-500 hover:text-white hover:bg-gray-600 transition-colors shrink-0"
            >
              {isFullscreen ? (
            ...
            <button className="relative p-1.5 sm:p-2 rounded-lg text-gray-500 hover:text-white hover:bg-gray-600 transition-colors shrink-0">
              ...
              >
                ...
                <div className="flex items-center gap-3 pb-3 border-b border-gray-200">
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold text-sm sm:text-base truncate">{name || "Admin"}</p>
                    <p className="text-xs sm:text-sm text-gray-500 truncate">{email}</p>
                  </div>
                </div>

                <div className="mt-3 space-y-1">
                  <Link to="/profile" className="flex items-center gap-3 w-full px-3 py-2 rounded-lg hover:bg-gray-50 hover:text-gray-800 text-gray-500 text-md">
